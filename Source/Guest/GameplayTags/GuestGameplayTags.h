...
namespace GuestGameplayTags
{
	...
	GUEST_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_InputTag_Attack);

	//Ability
	GUEST_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ability_Interact);
	GUEST_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Ability_Melee);
	...
	//GE SetByCaller 데이터
	GUEST_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Data_Damage);
